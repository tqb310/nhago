...
const datas = [
    {
        ...
        image: 'https://nhagoanphu.com/image/catalog/mau-nha-go/nha-tho-tu-duong/NTD-04/nha-tu-duong-4.8.jpg',
        content:
    ...
    return (
        <div className='cursor-pointer p-2'>
            ...
            >
                ...
                />
                <span
                    className={'hover:underline ' + (expand ? 'underline' : '')}
                >
                    {title}
                </span>
            </div>
            <div
                className={
                    'flex p-2 border-2 rounded-md ' + (expand ? '' : 'hidden')
                }
            >
