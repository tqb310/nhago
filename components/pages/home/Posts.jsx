...
const data = [
    {
        image: 'https://nhagoanphu.com/image/catalog/mau-nha-go/nha-tho-tu-duong/NTD-02/nha-tu-duong-2.1.JPG',
    ...
    {
        image: 'https://nhagoanphu.com/image/cache/catalog/mau-nha-go/nha-nam-bo/mau-hue4/nha-hue1-300x300.jpg',
        title: 'Tư vấn và thiết kế theo yêu cầu',
        content:
            'Làm thế nào để bạn có thể sở hữu được một không gian sống thoải mái và tiện nghi? Bạn cũng sẽ muốn một ngôi nhà thể hiện được đúng cá tính, sở thích riêng và thỏa mãn được mong muốn của gia đình mình...',
    },
...
function Posts() {
    ...
    return (
        <div className='flex-1 ml-4 relative'>
            ...
            <div className=''>
                {data
                    .slice(landingIndex * 3, landingIndex * 3 + 3)
                    .map((d, index) => (
                        <div key={index}>
                            <Post
                                image={d.image}
