...
function Furniture({ posts }) {
    return (
        <>
            <Head>
                <title>
                    Công ty thiết kế và thi công nội thất tốt nhất -
                    Nhagobamien.vn
                </title>
            ...
            >
                ...
                <div className='mt-8 mb-16 after:clear-left after:table'>
                    ...
                    <p className='leading-8 text-justify'>
                        ...
                        theo yêu cầu của khách hàng là một trong những dịch vụ
                        cốt lõi của Nhà Gỗ Ba Miền chúng tôi. Với kinh nghiệm và
                        tay nghề cao (đục, trạm, khắc…) của các thợ lành nghề
                        được tuyển chọn kỹ trong làng mộc truyền thống Hà Thái
                        Chúng tôi đã hoàn thành hàng trăm dự án mỗi năm và làm
                        hài lòng tất cả các khách hàng khi đến với Nhà Gỗ Ba
                        Miền.
                    </p>
                    ...
                    <p className='leading-8 text-justify'>
                        Một vài sản phẩm điển hình trong thiết kế nội thất mà
                        Nhà Gỗ Ba Miền chúng tôi cung cấp như Cửa, Trần, Cầu
                        Thang, Ốp Tường… cho đến Bàn ghế, Giường , Tủ quần áo,
                        Tủ trưng bày…
                    </p>
                </div>
                <div className='w-full bg-gray-200 px-4 py-4 text-center my-8'>
                    ...
                    <address className='text-sm md:text-lg leading-loose font-normal'>
                        ...
                        TP.HCM. <br />
                        Văn phòng chi nhánh: 305/24 Đường TA28, KP 5, Quận 12,
                        TP.HCM <br />
